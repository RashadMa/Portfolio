export const Bio = {
  ...
  description:
    "Experienced Frontend and Mobile Developer with a passion for crafting seamless user experiences. Proficient in React for web applications and React Native for cross-platform mobile development. Skilled in creating dynamic, interactive interfaces that elevate user engagement. Possesses a proven track record of delivering high-quality, performance-driven solutions. Committed to staying updated with the latest industry trends to ensure cutting-edge development. Explore my portfolio to see how I bring ideas to life with a blend of creativity and technical expertise..",
